...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  ;Customize(setq gc-cons-threshold 20000000)
  ...
  ; Customize (setq vc-follow-symlinks t)
  ...
  ; Customize (setq confirm-kill-emacs 'y-or-n-p)

  ; (sensible-defaults/quiet-startup)
  ; Customize (setq inhibit-startup-message t)
  ; Customize (setq initial-scratch-message nil)
  ...
  (show-paren-mode t)
  ; Customize (setq show-paren-delay 0.0)
...
* Company mode, winner mode, ido mode
#+BEGIN_SRC  emacs-lisp :tangle yes
(company-mode)
(winner-mode 1)
